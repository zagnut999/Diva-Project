...
void ShowOneLineCentered2(int textSize, char text[], int length)
{
  //Serial.println(text);
  // Show text
  display2.clearDisplay();
  display2.setTextSize(textSize);
  display2.setCursor((WIDTH - length * SIZE1WIDTH * textSize)/2 , (HEIGHT - SIZE1HEIGHT * textSize) / 2);
  display2.println(text);
  
  display2.display();
}

void ShowOneLineCentered3(int textSize, char text[], int length)
{
  //Serial.println(text);
  // Show text
  display3.clearDisplay();
  display3.setTextSize(textSize);
  display3.setCursor((WIDTH - length * SIZE1WIDTH * textSize)/2 , (HEIGHT - SIZE1HEIGHT * textSize) / 2);
  display3.println(text);
  
  display3.display();
}

void ShowOneLineCentered4(int textSize, char text[], int length)
{
  //Serial.println(text);
  // Show text
  display4.clearDisplay();
  display4.setTextSize(textSize);
  display4.setCursor((WIDTH - length * SIZE1WIDTH * textSize)/2 , (HEIGHT - SIZE1HEIGHT * textSize) / 2);
  display4.println(text);
